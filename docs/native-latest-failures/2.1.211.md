# Native latest candidate failure: 2.1.211

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/29475224019
- Head SHA: `1941cfc02e5975a0f9ab86126ca63905fe4fe6c1`
- Status: `fail`
- Candidate kind: `native`
- Native: `darwin-arm64` / `ok` / `ok` / `ok`
- Display audit: `fail` (72 issues / 11 commands)
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.211

- Added upstream strings: 28317
- Removed upstream strings: 15148
- Already covered by translations: 141
- Needs translation review: 28176
- Sensitive review hints: 527
