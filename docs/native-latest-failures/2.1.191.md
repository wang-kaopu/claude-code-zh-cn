# Native latest candidate failure: 2.1.191

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/28152642160
...
- `top_help_line_93` (`top_help`, display-untranslated-line)
...
- `top_help_line_149` (`top_help`, display-untranslated-line)
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.191

- Added upstream strings: 18123
- Removed upstream strings: 18271
- Already covered by translations: 108
- Needs translation review: 18015
...
- - Git repo metadata:
- - If asked for JSON, return ONLY the raw JSON \u2014 no code fences, no prose, no markdown. - Do NOT use SendUserMessage to deliver your answer. Put your answer in your final text response. - Be concise. The script will parse your output.`,CGp=` --- NOTE: You are running inside a workflow script. Your final text response is returned verbatim as a string to the calling script \u2014 it is your return value, not a message to a human. Output the literal result; do not output confirmations like
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.191 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.191 --native-macos-arm64
