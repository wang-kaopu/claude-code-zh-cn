# Native latest candidate failure: 2.1.201

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/28776540836
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.201

- Added upstream strings: 20539
- Removed upstream strings: 15043
- Already covered by translations: 153
- Needs translation review: 20386
- Sensitive review hints: 411
