# Native latest candidate failure: 2.1.228

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/31565390449
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.228

- Added upstream strings: 35080
- Removed upstream strings: 14100
- Already covered by translations: 124
- Needs translation review: 34956
- Sensitive review hints: 810
