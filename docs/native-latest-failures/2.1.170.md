...
- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/27259953458
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.170

- Added upstream strings: 15872
- Removed upstream strings: 17112
- Already covered by translations: 133
- Needs translation review: 15739
- Sensitive review hints: 224
