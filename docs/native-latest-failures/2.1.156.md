...
- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/26623342117
...
```markdown
# Upstream text diff: 2.1.150 -> 2.1.156

- Added upstream strings: 8620
- Removed upstream strings: 5664
- Already covered by translations: 194
- Needs translation review: 8426
