# Native latest candidate failure: 2.1.195

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/28358771202
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.195

- Added upstream strings: 20035
- Removed upstream strings: 20168
- Already covered by translations: 108
- Needs translation review: 19927
