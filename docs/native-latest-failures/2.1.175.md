# Native latest candidate failure: 2.1.175

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/27403009326
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.175

- Added upstream strings: 12727
- Removed upstream strings: 16543
- Already covered by translations: 127
- Needs translation review: 12600
- Sensitive review hints: 205
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.175 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.175 --native-macos-arm64
