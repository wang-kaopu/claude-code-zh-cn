# Native latest candidate failure: 2.1.226

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/31357044218
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.226

- Added upstream strings: 30378
- Removed upstream strings: 16521
- Already covered by translations: 116
- Needs translation review: 30262
