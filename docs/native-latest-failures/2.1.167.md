# Native latest candidate failure: 2.1.167

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/27055231964
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.167

- Added upstream strings: 10526
- Removed upstream strings: 14853
- Already covered by translations: 88
- Needs translation review: 10438
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.167 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.167 --native-macos-arm64
