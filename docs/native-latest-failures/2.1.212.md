# Native latest candidate failure: 2.1.212

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/29558650891
- Head SHA: `1941cfc02e5975a0f9ab86126ca63905fe4fe6c1`
- Status: `fail`
- Candidate kind: `native`
- Native: `darwin-arm64` / `ok` / `ok` / `ok`
- Display audit: `fail` (76 issues / 11 commands)
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.212

- Added upstream strings: 24156
- Removed upstream strings: 14776
- Already covered by translations: 139
- Needs translation review: 24017
- Sensitive review hints: 479
