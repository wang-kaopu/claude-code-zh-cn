# Native latest candidate failure: 2.1.187

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/28081028738
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.187

- Added upstream strings: 17286
- Removed upstream strings: 17793
- Already covered by translations: 136
- Needs translation review: 17150
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.187 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.187 --native-macos-arm64
