# Native latest candidate failure: 2.1.214

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/29632564348
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.214

- Added upstream strings: 27232
- Removed upstream strings: 14132
- Already covered by translations: 134
- Needs translation review: 27098
- Sensitive review hints: 486
