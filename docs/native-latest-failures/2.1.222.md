# Native latest candidate failure: 2.1.222

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/30979990605
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.222

- Added upstream strings: 30456
- Removed upstream strings: 15896
- Already covered by translations: 104
- Needs translation review: 30352
- Sensitive review hints: 683
