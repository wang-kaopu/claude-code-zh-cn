# Native latest candidate failure: 2.1.185

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/27942709883
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.185
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.185 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.185 --native-macos-arm64
