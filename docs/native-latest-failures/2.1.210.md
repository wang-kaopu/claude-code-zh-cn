# Native latest candidate failure: 2.1.210

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/29392137980
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.210

- Added upstream strings: 24470
- Removed upstream strings: 14601
- Already covered by translations: 164
- Needs translation review: 24306
- Sensitive review hints: 529
