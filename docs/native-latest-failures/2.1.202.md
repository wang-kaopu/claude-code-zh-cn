# Native latest candidate failure: 2.1.202

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/28847643238
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.202

- Added upstream strings: 21242
- Removed upstream strings: 16158
- Already covered by translations: 154
- Needs translation review: 21088
- Sensitive review hints: 408
