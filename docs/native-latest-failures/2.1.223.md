# Native latest candidate failure: 2.1.223

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/31076152748
- Head SHA: `1941cfc02e5975a0f9ab86126ca63905fe4fe6c1`
- Status: `fail`
- Candidate kind: `native`
- Native: `darwin-arm64` / `ok` / `ok` / `ok`
- Display audit: `fail` (79 issues / 11 commands)
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.223

- Added upstream strings: 30203
- Removed upstream strings: 15483
- Already covered by translations: 113
- Needs translation review: 30090
- Sensitive review hints: 706
