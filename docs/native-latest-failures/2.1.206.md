# Native latest candidate failure: 2.1.206

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/29075173261
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.206

- Added upstream strings: 22244
- Removed upstream strings: 16625
- Already covered by translations: 133
- Needs translation review: 22111
- Sensitive review hints: 422
