# Native latest candidate failure: 2.1.159

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/26744652235
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.159

- Added upstream strings: 5837
- Removed upstream strings: 4520
- Already covered by translations: 30
- Needs translation review: 5807
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.159 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.159 --native-macos-arm64
