# Native latest candidate failure: 2.1.183

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/27863825674
- Head SHA: `1941cfc02e5975a0f9ab86126ca63905fe4fe6c1`
- Status: `fail`
- Candidate kind: `native`
- Native: `darwin-arm64` / `ok` / `ok` / `ok`
- Display audit: `fail` (49 issues / 11 commands)
...
- `top_help_line_77` (`top_help`, display-untranslated-line)

  ```text
  --print ä¸ --output-format=stream-json
  ```

- `top_help_line_90` (`top_help`, display-untranslated-line)
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.183

- Added upstream strings: 15586
- Removed upstream strings: 16994
- Already covered by translations: 101
- Needs translation review: 15485
- Sensitive review hints: 358
...
- - Git repo metadata:
- - If asked for JSON, return ONLY the raw JSON \u2014 no code fences, no prose, no markdown. - Do NOT use SendUserMessage to deliver your answer. Put your answer in your final text response. - Be concise. The script will parse your output.`,d0p=` --- NOTE: You are running inside a workflow script. Your final text response is returned verbatim as a string to the calling script \u2014 it is your return value, not a message to a human. Output the literal result; do not output confirmations like
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.183 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.183 --native-macos-arm64
