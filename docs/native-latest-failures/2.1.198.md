# Native latest candidate failure: 2.1.198

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/28571233586
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.198

- Added upstream strings: 23095
- Removed upstream strings: 14296
- Already covered by translations: 127
- Needs translation review: 22968
- Sensitive review hints: 395
