# Native latest candidate failure: 2.1.197

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/28502225461
- Head SHA: `1941cfc02e5975a0f9ab86126ca63905fe4fe6c1`
- Status: `fail`
- Candidate kind: `native`
- Native: `darwin-arm64` / `ok` / `ok` / `ok`
- Display audit: `fail` (54 issues / 11 commands)
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.197

- Added upstream strings: 19173
- Removed upstream strings: 19586
- Already covered by translations: 109
- Needs translation review: 19064
- Sensitive review hints: 377
