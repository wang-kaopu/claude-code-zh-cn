# Native latest candidate failure: 2.1.216

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/29806032922
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.216

- Added upstream strings: 22346
- Removed upstream strings: 17499
- Already covered by translations: 94
- Needs translation review: 22252
- Sensitive review hints: 301
