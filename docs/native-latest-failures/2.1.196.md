# Native latest candidate failure: 2.1.196

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/28426567624
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.196

- Added upstream strings: 19154
- Removed upstream strings: 19583
- Already covered by translations: 109
- Needs translation review: 19045
