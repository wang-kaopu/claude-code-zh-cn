# Native latest candidate failure: 2.1.205

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/29000004948
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.205

- Added upstream strings: 22113
- Removed upstream strings: 16682
- Already covered by translations: 139
- Needs translation review: 21974
