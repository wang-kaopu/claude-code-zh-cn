# Native latest candidate failure: 2.1.181

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/27746452766
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.181

- Added upstream strings: 15427
- Removed upstream strings: 16988
- Already covered by translations: 95
- Needs translation review: 15332
- Sensitive review hints: 346
