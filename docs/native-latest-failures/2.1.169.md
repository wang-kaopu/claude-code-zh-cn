...
- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/27189467439
- Head SHA: `1941cfc02e5975a0f9ab86126ca63905fe4fe6c1`
- Status: `fail`
- Candidate kind: `native`
- Native: `darwin-arm64` / `ok` / `ok` / `ok`
- Display audit: `fail` (24 issues / 11 commands)
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.169

- Added upstream strings: 15971
- Removed upstream strings: 16889
- Already covered by translations: 110
- Needs translation review: 15861
