# Native latest candidate failure: 2.1.186

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/28008360499
- Head SHA: `1941cfc02e5975a0f9ab86126ca63905fe4fe6c1`
- Status: `fail`
- Candidate kind: `native`
- Native: `darwin-arm64` / `ok` / `ok` / `ok`
- Display audit: `fail` (51 issues / 11 commands)
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.186

- Added upstream strings: 17971
- Removed upstream strings: 17801
- Already covered by translations: 147
- Needs translation review: 17824
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.186 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.186 --native-macos-arm64
