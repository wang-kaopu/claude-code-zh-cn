# Native latest candidate failure: 2.1.220

- Run: https://github.com/wang-kaopu/claude-code-zh-cn/actions/runs/30790857685
...
```markdown
# Upstream text diff: 2.1.156 -> 2.1.220

- Added upstream strings: 27549
- Removed upstream strings: 14246
- Already covered by translations: 126
- Needs translation review: 27423
- Sensitive review hints: 555
